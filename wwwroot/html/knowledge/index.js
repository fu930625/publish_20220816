    ...
    vm = new Vue({
        ...
        data: {
            ...
            , onQuery: function () {
                ...
                window.location.href = '../component.html?anno_component_name=anno-kn-doc-add';
            }
        }, created: function () {
            $("#knowledge").show();
        }
...
function LoadData(page,pagesize) {
    ...
    anno.process(input, "Anno.Plugs.Logic/KNDocument/GetDocumentPageListByMember", function (data) {
        vm.mData = data.Rows;
